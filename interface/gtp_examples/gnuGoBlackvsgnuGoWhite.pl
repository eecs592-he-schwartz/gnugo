...
$program[0] = 'gnugo --komi 6.5 --mode gtp --score aftermath --capture-all-dead --chinese-rules --quiet';
...
$program[1] = 'gnugo --komi 6.5 --mode gtp --score aftermath --capture-all-dead --chinese-rules --quiet';
